...
const SectionHeader: React.FC<{ title: string, subtitle?: string, icon?: React.ReactNode }> = ({ title, subtitle, icon }) => (
  <div className={Theme.components.sectionHeader}>
    ...
    <div>
      ...
      {subtitle && <p className={Theme.components.headerSubtitle}>{subtitle}</p>}
    </div>
  </div>
);
...
export const DayanPanel: React.FC<Props> = ({ info }) => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 p-4 max-w-7xl mx-auto">
      ...
      {/* TAI SHI JIAN LOGBOOK */}
      <div className={`md:col-span-12 ${Theme.bg.panel} border ${Theme.colors.borderHighlight} p-8 rounded relative overflow-hidden`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
           {/* Solar Track */}
           <div className={`${Theme.bg.dark}/30 p-5 rounded border ${Theme.colors.border}/30`}>
        ...
        {/* CIVIL CALENDAR ENTRY (Daily Hexagram) */}
        <div className={`mt-8 border-t ${Theme.colors.borderHighlight} pt-6`}>
           ...
           <div className={`${Theme.bg.card} border ${Theme.colors.border} grid grid-cols-1 md:grid-cols-12 overflow-hidden rounded-sm`}>
               ...
               <div className={`md:col-span-3 p-6 border-b md:border-b-0 md:border-r border-stone-800 flex flex-col justify-center items-center ${Theme.bg.dark}/20 relative`}>
      ...
      <div className="md:col-span-6">
        <div className={Theme.components.card + " h-full"}>
      ...
      <div className="md:col-span-6">
        <div className={Theme.components.card + " h-full"}>
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
                <div className={Theme.components.valueBox}>
      ...
      {/* MATH CORE */}
      <div className={`md:col-span-12 ${Theme.bg.darker}/60 border ${Theme.colors.border} p-8 rounded relative overflow-hidden`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
           <div className="space-y-4">
              ...
              <div className={`${Theme.bg.dark}/80 p-3 mt-3 border border-stone-800/50 rounded`}>
                <span className="text-xs text-stone-500 block mb-1">基础法则:</span>
                <span className="text-sm text-stone-300 font-mono">一日 = 3040 分</span>
              </div>
           </div>
           
           <div className={`col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-6 ${Theme.bg.dark}/50 p-6 rounded border border-stone-800/50`}>
              <MathDisplay 
                label="步朔术 (朔实)" 
